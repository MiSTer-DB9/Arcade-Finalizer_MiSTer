...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Finalizer_MiSTer.git"
CORE_NAME=(Arcade-Finalizer)
...
UPSTREAM_CORE_NAME=(Arcade-Finalizer)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Finalizer.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Finalizer.rbf)
